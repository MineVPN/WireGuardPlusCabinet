...
// Новые установки хранят хеш в /var/www/wgplus-auth (ВНЕ docroot), и эта
// строка не используется. Оставлена для совместимости с установками,
// которые ещё не прошли миграцию через update.sh — формат менять нельзя.
