  ...
  <div class="card">
    ...
    <div class="qa">
      ...
      <details class="qa__item">
        ...
        <div class="qa__a">
          <p style="margin-bottom:var(--s-2)">Так и задумано: если второй впн лёг, интернет
          отключается специально. Иначе трафик пошёл бы мимо него — с адресом этого сервера,
          и вы бы этого не заметили.</p>
          <p>Решение: зайдите в <strong>Подключение</strong> и нажмите
          <strong>«Отключить и удалить конфиг»</strong>. Сервер вернётся к обычной работе,
          интернет появится сразу — но уже без второй страны.</p>
        </div>
      </details>
