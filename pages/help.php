...
<div class="stack">
  ...
  <div class="card">
    ...
    <div class="callout callout--warn" style="margin-top: var(--s-5)">
      ...
      <span>
        ...
        страны покупается отдельно, подходит обычный Wireduard (не плюс).
      </span>
    </div>
  </div>
      ...
      <div class="step">
        ...
        <div>
          ...
          <div class="step__body">
            ...
            <p>Также поддерживается установка на Mine Server Panel</p>
          </div>
        </div>
      </div>
      ...
      <div class="step">
        ...
        <div>
          ...
          <div class="step__body">
            ...
            <strong>«Если второй впн упадёт»</strong> — выберите там один из двух вариантов.</p>
            ...
            <p><strong>Kill Switch</strong> — интернет отключится полностью, пока второй впн
            не вернётся. Нужен, когда важно, чтобы сайты видели только страну
            второго впн и никогда — европейскую.</p>
            <p>Поменять можно в любой момент — настройка применяется за 15 секунд.</p>
          </div>
        </div>
      </div>
  ...
  <div class="card">
    ...
    <div class="facts">
      ...
      <div class="fact">
        ...
        <span class="fact__v" style="font-family:var(--font-ui);text-align:right;max-width:60%">
          Проверка связи. По умолчанию идёт тем же путём, что и трафик клиента
        </span>
      </div>
      <div class="fact">
  ...
  <div class="card">
    ...
    <div class="qa">
      ...
      <details class="qa__item">
        <summary class="qa__q">Пишет «конфиг не подходит, адрес пересекается»</summary>
        <div class="qa__a">
          <p style="margin-bottom:var(--s-2)">У второго впн такие же внутренние адреса,
          как у ваших клиентов (<span class="data"><?= htmlspecialchars($net['cidr']) ?></span>).
          Сервер не сможет понять, куда отправлять ответы.</p>
          <p style="margin-bottom:var(--s-2)">Панель отклоняет такой конфиг сразу,
          и это к лучшему: иначе всё бы заработало, а сломалось позже — после
          перезагрузки сервера, без видимой причины.</p>
          <p>Решение: попросите у продавца второго впн другой конфиг —
          с другой внутренней адресацией. Они обычно могут выдать сразу,
          это частая просьба.</p>
        </div>
      </details>
