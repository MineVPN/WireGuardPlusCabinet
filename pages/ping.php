 ...
 * Путь выбирается вручную: через второй VPN или напрямую через сервер.
 * Сравнение двух замеров сразу показывает, где рвётся связь.
 */
...
<div class="page-head">
  ...
  <p class="page-head__note">
    Проверьте один адрес двумя путями. Если напрямую отвечает, а через второй VPN нет —
    проблема на стороне второго VPN, а не сервера.
  </p>
</div>
    ...
    <div class="ping-controls">
      ...
      <div class="field">
        ...
        <select id="path" class="select">
          ...
          <option value="wg1">Через второй VPN</option>
          <option value="nic">Напрямую через сервер</option>
        </select>
      </div>
      <div class="field">
